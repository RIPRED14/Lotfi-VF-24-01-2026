...
const siteProducts = {
  'R1': [
    ...
    { id: 'dessert_vegetal_non_fermente', name: 'Dessert végétal non fermenté', products: [] },
    { id: 'eaux_de_rincage', name: 'Eaux de rincage', products: [] },
    { id: 'mains', name: 'Mains', products: [] },
    { id: 'air_statique', name: 'Air Statique', products: [] },
    { id: 'materiel', name: 'Materiel', products: [] }
  ],
  'R2': [
